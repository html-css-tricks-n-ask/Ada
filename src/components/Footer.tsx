...
export default function Footer() {
  return (
    <footer id="contact" className="w-full bg-black text-white border-t border-neutral-900 overflow-hidden">
      {/* Main Footer Container */}
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 pt-14 sm:pt-20 pb-12 sm:pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-9 sm:gap-10 lg:gap-8 xl:gap-12">
          ...
          <div className="flex flex-col space-y-3.5 sm:space-y-4">
            <h4 className="font-abhaya font-bold text-[18px] sm:text-[20px] text-[#DFC377] tracking-wide">
              Quick Links
            </h4>
            <ul className="flex flex-col space-y-2.5 sm:space-y-3 font-work font-normal text-[14px] sm:text-[15px] text-white/90">
              <li>
                <Link href="#founder" className="hover:text-[#FCF38A] transition-colors">
                  Who We Are
                </Link>
              </li>
              <li>
          ...
          <div className="flex flex-col space-y-5 sm:space-y-6">
            <div>
              <h4 className="font-abhaya font-bold text-[18px] sm:text-[20px] text-[#DFC377] tracking-wide mb-2 sm:mb-3">
                Business Hours
              </h4>
              <div className="font-work font-normal text-[14px] sm:text-[15px] text-white/90 space-y-0.5 sm:space-y-1">
                <p>Monday - Thursday</p>
            ...
            <div>
              ...
              <div className="font-work font-normal text-[14px] sm:text-[15px] text-white/90 space-y-0.5 sm:space-y-1">
                ...
                <a
                  ...
                  className="text-white hover:text-[#FCF38A] underline decoration-neutral-600 transition-colors break-all"
                >
          ...
          <div className="flex flex-col space-y-5 pt-2 sm:pt-0">
            ...
            {/* Location */}
            <div>
              <h4 className="font-abhaya font-bold text-[16px] sm:text-[17px] text-[#DFC377] tracking-wide mb-1.5">
                Locate us
              </h4>
              <p className="font-work font-normal text-[13px] sm:text-[14px] leading-relaxed text-white/90">
                ...
                <br />
                <a href="tel:4805269292" className="hover:text-[#FCF38A] transition-colors">
                  Phone: 480-526-9292
                </a>
              </p>
            </div>
            ...
            {/* Social Icons */}
            <div>
              <h4 className="font-abhaya font-bold text-[16px] sm:text-[17px] text-[#DFC377] tracking-wide mb-2.5">
                Follow us
              </h4>
              <div className="flex items-center gap-4 text-white">
                {/* Instagram */}
                <a href="#instagram" aria-label="Instagram" className="hover:text-[#FCF38A] transition-colors p-1 -m-1">
                ...
                {/* Facebook */}
                <a href="#facebook" aria-label="Facebook" className="hover:text-[#FCF38A] transition-colors p-1 -m-1">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                  </svg>
                </a>
                {/* Twitter / X */}
                <a href="#twitter" aria-label="Twitter" className="hover:text-[#FCF38A] transition-colors p-1 -m-1">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z" />
                  </svg>
                </a>
                {/* TikTok */}
                <a href="#tiktok" aria-label="TikTok" className="hover:text-[#FCF38A] transition-colors p-1 -m-1">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <a href="#linkedin" aria-label="LinkedIn" className="hover:text-[#FCF38A] transition-colors p-1 -m-1">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
